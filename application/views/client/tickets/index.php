                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                               ...
                               <!--  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= client_url(); ?>client/edit/<?php echo $this->utility->encode($getComany[$i]->companyId);?>">
                                                <i class="fa fa-edit text-navy"></i>
                                            </a>
                                            <a data-toggle="modal" data-target="#myModal_autocomplete" data-href="<?= client_url().'ticket/clientDelete'?>" data-id="<?php echo $getComany[$i]->companyId;?>" class="deletebutton">
                                                <i class="fa fa-close text-navy"></i>
                                            </a>
                                            <a href="<?= client_url(); ?>client/detail/<?php echo $this->utility->encode($getComany[$i]->companyId);?>"><i class="fa fa-user text-navy"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
