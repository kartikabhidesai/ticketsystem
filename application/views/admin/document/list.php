                                ...
                                <?php for ($i = 0; $i < count($docsArray); $i++) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-toggle="modal" title="Delete" data-target="#myModal_autocomplete"  class="deleteLabel" data-url="<?php echo admin_url() . 'document/deleteDocument' ?>" data-id="<?php echo $docsArray[$i]->id; ?>" ><i class="fa fa-close text-navy"></i></a>        
                                            <!--<a data-id="<?php echo $docsArray[$i]->id; ?>" href="<?php echo admin_url() . 'document/addLabel/' . $docsArray[$i]->id ?>" class="itemModel" ><i class="fa fa-anchor text-navy"></i></a>-->        
