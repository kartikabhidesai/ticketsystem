    ...
    <tbody class="appendHtml">
        <?php for ($i = 0; $i < count($lableInfo); $i++) { ?>
            <tr>
                ...
                <td>
                    <a data-toggle="modal" data-target="#myModal_autocomplete" data-url="<?php echo admin_url() . 'document/deleteDocumentInfo' ?>" data-id="<?php echo $lableInfo[$i]['id']; ?>" class="deleteItem" href="javascript:;"><i class="fa fa-close text-navy"></i></a>        
                </td>
            </tr>
        <?php
        }
