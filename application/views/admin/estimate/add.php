<div class="wrapper wrapper-content white-bg m-t">
    <div class=" animated fadeInRightBig">
        <form method="post" class="form-horizontal"  enctype="multipart/form-data"  action="<?= admin_url(); ?>estimate/add" id='invoiceAdd'>
            <div class="form-group headingmain">						
                <h2 class="title" style="margin:10px"> Estimate Details</h2>								
            </div>
